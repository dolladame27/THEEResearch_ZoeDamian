## PARAMETERS
N0  <- 1000   # initial total population size
...
f_A <- 1.5       # density-sensitivity of mutant
...
# Core Rebound Time Analysis - Without Timing Strategies
...
2. REBOUND TIME PATTERNS:
   - Strong negative correlation between p₀ and rebound time
